...
<head>
  ...
  <title>Catalog | Supp My Coffee</title>
...
<body>
  ...
  <nav class="navbar fixed-top bg-white navbar-expand-lg navbar-light ">
    <div class="container py-1 d-lg-flex align-items-lg-center">
      ...
      <div class="collapse mt-3 mt-lg-0 navbar-collapse justify-content-between align-items-center toggle"
        id="navbarNav">
        <div class="left-content ms-lg-3 d-flex justify-content-start">
          <ul
            class="navbar-nav gap-3 text-lg-start mt-4 mb-4 mb-lg-0 mt-lg-0 d-flex align-items-start align-items-lg-center">
            <li class="nav-item mt-3 mt-lg-0">
              <div class="nav-link dropdown ddn-ctg p-0 bg-transparent border-0">
                ...
                <ul class="menu">
                  <li><a href="{{route('customer.catalog.searchByCategory', 'Arabika')}}"
                      class="text-decoration-none text-black title">Arabika</a></li>
                  <li><a href="{{route('customer.catalog.searchByCategory', 'Robusta')}}"
                      class="text-decoration-none text-black title">Robusta</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item mt-3 mt-lg-0">
        ...
        <div class="right-content align-items-start d-flex flex-column flex-lg-row  gap-3  ">
          ...
          <a href="{{route('customer.account')}}"
            class="text-decoration-none text-black account d-flex align-items-center gap-2">
          ...
          <div class="box d-flex flex-column">
            <a href="{{route('customer.catalog.detail', $product->id)}}" class="text-decoration-none">
              <div class="product-img"><img loading="lazy"
                  src="{{ asset('storage/thumbnail/'.$product->produk_thumbnail)}}" class="img-fluid"></div>
            </a>
        ...
        <div class="row row-1 mt-5">
          <div class="col-12 col-lg-6">
            <div class="content d-flex flex-column gap-3">
              <div class="img-wrap col-2"><img loading="lazy" class="img-fluid rounded-4"
                  src="{{ asset('Assets/img/Logo.png')}}"></div>
              <div class="text col-7">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Enim vitae consequuntur
                recusandae possimus soluta corporis </div>
          ...
          <div class="col-12 col-lg-6 d-flex gap-5 mt-4 mt-lg-0">
            <div class="link-wrap col-1 col-md-2 d-flex flex-column gap-3">
              ...
              <div class="child d-flex flex-column gap-1">
                ...
                <a href="#" class="text-decoration-none text-black">
                  <p class="m-0">Select Product</p>
                </a>
                <a href="#" class="text-decoration-none text-black">
                  <p class="m-0">Best Product</p>
                </a>
                <a href="#" class="text-decoration-none text-black">
            ...
            <div class="link-wrap col-1 col-md-2 d-flex flex-column gap-3">
              ...
              <div class="child d-flex flex-column gap-1">
                ...
                <a href="{{route('admin.login')}}" class="text-decoration-none text-black">
                  <p class="m-0">Admin</p>
                </a>
              </div>
            </div>
